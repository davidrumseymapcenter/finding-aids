...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.4.0/x86_64-darwin24")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/moham/.rubies/ruby-3.4.1")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/moham/.rubies/ruby-3.4.1' '--with-opt-dir=/usr/local/opt/readline:/usr/local/opt/libyaml:/usr/local/opt/gdbm' '--with-openssl-dir=/usr/local/opt/openssl@3'"
  ...
  CONFIG["arch"] = "x86_64-darwin24"
  CONFIG["sitearchincludedir"] = "$(includedir)/$(sitearch)"
  CONFIG["archincludedir"] = "$(includedir)/$(arch)"
  CONFIG["sitearchlibdir"] = "$(libdir)/$(sitearch)"
  CONFIG["archlibdir"] = "$(libdir)/$(arch)"
  CONFIG["libdirname"] = "libdir"
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/moham/.rubies/ruby-3.4.1"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/usr/local/Cellar/readline/8.2.13/lib -L/usr/local/Cellar/libyaml/0.2.5/lib -L/usr/local/Cellar/gdbm/1.24/lib -Wl,-undefined,dynamic_lookup"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["POSTLINK"] = "dsymutil $@ 2>/dev/null; { test -z '$(RUBY_CODESIGN)' || codesign -s '$(RUBY_CODESIGN)' $@; }"
  CONFIG["incflags"] = "-I/usr/local/Cellar/readline/8.2.13/include -I/usr/local/Cellar/libyaml/0.2.5/include -I/usr/local/Cellar/gdbm/1.24/include"
  ...
  CONFIG["LDFLAGS"] = "-L. -fstack-protector-strong -L/usr/local/Cellar/readline/8.2.13/lib -L/usr/local/Cellar/libyaml/0.2.5/lib -L/usr/local/Cellar/gdbm/1.24/lib"
  ...
  CONFIG["wasmoptflags"] = ""
  CONFIG["WASMOPT"] = ""
  CONFIG["config_target"] = "x86_64-apple-darwin24.3.0"
  CONFIG["target_os"] = "darwin24"
  ...
  CONFIG["host"] = "$(target)"
  CONFIG["build_os"] = "darwin24.3.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "x86_64"
  CONFIG["build"] = "x86_64-apple-darwin24.3.0"
