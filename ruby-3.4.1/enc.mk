...
encsrcdir = ./enc
topdir = .
prefix = /Users/moham/.rubies/ruby-3.4.1
exec_prefix = /Users/moham/.rubies/ruby-3.4.1
libdir = /Users/moham/.rubies/ruby-3.4.1/lib
top_srcdir = $(encsrcdir:/enc=)
srcdir = $(top_srcdir)
tooldir = $(top_srcdir)/tool
arch = x86_64-darwin24
EXTOUT = .ext
...
INCFLAGS = -I. -I$(arch_hdrdir) -I$(hdrdir) -I$(top_srcdir) -I/usr/local/Cellar/readline/8.2.13/include -I/usr/local/Cellar/libyaml/0.2.5/include -I/usr/local/Cellar/gdbm/1.24/include
DEFS = 
CPPFLAGS = -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT   -DONIG_ENC_REGISTER=rb_enc_register
LDFLAGS = -L. -fstack-protector-strong -L/usr/local/Cellar/readline/8.2.13/lib -L/usr/local/Cellar/libyaml/0.2.5/lib -L/usr/local/Cellar/gdbm/1.24/lib
LDSHARED = clang -dynamic -bundle
POSTLINK = dsymutil $@ 2>/dev/null; { test -z '$(RUBY_CODESIGN)' || codesign -s '$(RUBY_CODESIGN)' $@; }
ldflags  = $(LDFLAGS)
dldflags = -L/usr/local/Cellar/readline/8.2.13/lib -L/usr/local/Cellar/libyaml/0.2.5/lib -L/usr/local/Cellar/gdbm/1.24/lib -Wl,-undefined,dynamic_lookup
