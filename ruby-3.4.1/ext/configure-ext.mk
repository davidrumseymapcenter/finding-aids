...
ext/zlib/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --extstatic $(EXTSTATIC) \
		-- configure $(@D)
gems: .bundle/gems/bigdecimal-3.1.8/exts.mk
.bundle/gems/bigdecimal-3.1.8/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --no-extstatic \
		-- configure $(@D)
gems: .bundle/gems/debug-1.10.0/exts.mk
.bundle/gems/debug-1.10.0/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --no-extstatic \
		-- configure $(@D)
...
.bundle/gems/racc-1.8.1/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --no-extstatic \
		-- configure $(@D)
gems: .bundle/gems/rbs-3.8.0/exts.mk
.bundle/gems/rbs-3.8.0/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --no-extstatic \
		-- configure $(@D)
gems: .bundle/gems/syslog-0.2.0/exts.mk
.bundle/gems/syslog-0.2.0/exts.mk: FORCE
	$(Q)$(MINIRUBY) $(srcdir)/ext/extmk.rb --make='$(MAKE)' \
		--command-output=$@ $(EXTMK_ARGS) --no-extstatic \
		-- configure $(@D)
